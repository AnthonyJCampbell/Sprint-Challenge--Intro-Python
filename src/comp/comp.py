...
print("\nStarts with D:")
# Loop over `humans` and check if the first letter of the name starts with "D"
...
c = [human.name for human in humans \
    if any(letter in human.name[0] for letter in ("C", "D", "E", "F", "G"))]
print(c)
...
print("\nAll names uppercase:")
g = [{"name": human.name.upper(), "age": human.age + 5} for human in humans]
print(g)
